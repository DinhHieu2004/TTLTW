...
public class GetDetail extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (type == null || id == null) {
            ...
            resp.getWriter().write("{\"error\": \"Missing type or id parameter.\"}");
            return;
        }
        ...
        try {
            ...
            if ("in".equalsIgnoreCase(type)) {
                ...
                resp.getWriter().write("{\"error\": \"Stock out detail not implemented yet.\"}");
            } else {
                resp.setStatus(HttpServletResponse.SC_BAD_REQUEST);
                resp.getWriter().write("{\"error\": \"Invalid type parameter.\"}");
                return;
            }
